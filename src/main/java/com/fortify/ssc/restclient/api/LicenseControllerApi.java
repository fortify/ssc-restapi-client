...
public class LicenseControllerApi {
     ...
     * get
     * 
     * @return ApiResultLicense
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResultLicense getLicense() throws ApiException {
        ApiResponse<ApiResultLicense> resp = getLicenseWithHttpInfo();
        return resp.getData();
    }
     ...
     * get
     * 
     * @return ApiResponse&lt;ApiResultLicense&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiResultLicense> getLicenseWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getLicenseValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<ApiResultLicense>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getLicenseAsync(final ApiCallback<ApiResultLicense> callback) throws ApiException {
